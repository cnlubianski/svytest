...
#'
#' @format A data frame with _n_ rows and _m_ variables:
#' \describe{
...
#' }
#'
#' @details This example dataset is a subset extracted from the complete CE dataset used by the
...
#'
#' @note For more information on the methodology and details behind the original dataset, please see:
#' Toth, D. (2021). *rpms: Recursive Partitioning for Modeling Survey Data* (v0.5.1). CRAN.
#' \url{https://CRAN.R-project.org/package=rpms}.
#'
#' @source \href{https://CRAN.R-project.org/package=rpms}{rpms package on CRAN}
#'
#' @seealso \code{\link[rpms]{rpms}} for an overview of the functions provided in the original package.
"svytestCE"
